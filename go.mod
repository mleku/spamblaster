module github.com/relaytools/spamblaster
...
require (
	...
	mleku.online/git/appdata v1.0.1 // indirect
	mleku.online/git/base58 v1.0.0 // indirect
	mleku.online/git/bech32 v1.0.3 // indirect
)

replace github.com/relaytools/spamblaster => ./
